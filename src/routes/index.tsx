...
const skills = [
  ...
  },
  {
    ...
    text: "Mapping business processes into software.",
  },
  {
    index: "03",
    name: "Python",
    category: "Core language",
    text: "Backend development and automation for Odoo work.",
  },
  {
    index: "04",
    name: "PostgreSQL",
    category: "Data storage",
    text: "Relational storage and queries for business apps.",
  },
  {
    index: "05",
    name: "TypeScript",
    category: "Typed JavaScript",
    text: "Typed interfaces for full-stack products.",
  },
  {
    index: "06",
    name: "Next.js",
    category: "React framework",
    text: "Full-stack React with server-side rendering.",
  },
  {
    index: "07",
    name: "ASP.NET",
